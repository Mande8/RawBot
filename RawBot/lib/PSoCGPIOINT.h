...
*/
// US_ECHO address and mask defines
#pragma	ioport	US_ECHO_Data_ADDR:	0x4
BYTE			US_ECHO_Data_ADDR;
#pragma	ioport	US_ECHO_DriveMode_0_ADDR:	0x104
BYTE			US_ECHO_DriveMode_0_ADDR;
#pragma	ioport	US_ECHO_DriveMode_1_ADDR:	0x105
BYTE			US_ECHO_DriveMode_1_ADDR;
#pragma	ioport	US_ECHO_DriveMode_2_ADDR:	0x7
BYTE			US_ECHO_DriveMode_2_ADDR;
#pragma	ioport	US_ECHO_GlobalSelect_ADDR:	0x6
BYTE			US_ECHO_GlobalSelect_ADDR;
#pragma	ioport	US_ECHO_IntCtrl_0_ADDR:	0x106
BYTE			US_ECHO_IntCtrl_0_ADDR;
#pragma	ioport	US_ECHO_IntCtrl_1_ADDR:	0x107
BYTE			US_ECHO_IntCtrl_1_ADDR;
...
// BL address and mask defines
#pragma	ioport	BL_Data_ADDR:	0x8
BYTE			BL_Data_ADDR;
#pragma	ioport	BL_DriveMode_0_ADDR:	0x108
BYTE			BL_DriveMode_0_ADDR;
#pragma	ioport	BL_DriveMode_1_ADDR:	0x109
BYTE			BL_DriveMode_1_ADDR;
#pragma	ioport	BL_DriveMode_2_ADDR:	0xb
BYTE			BL_DriveMode_2_ADDR;
#pragma	ioport	BL_GlobalSelect_ADDR:	0xa
BYTE			BL_GlobalSelect_ADDR;
#pragma	ioport	BL_IntCtrl_0_ADDR:	0x10a
BYTE			BL_IntCtrl_0_ADDR;
#pragma	ioport	BL_IntCtrl_1_ADDR:	0x10b
BYTE			BL_IntCtrl_1_ADDR;
#pragma	ioport	BL_IntEn_ADDR:	0x9
BYTE			BL_IntEn_ADDR;
#define BL_MASK 0x80
// BL Shadow defines
//   BL_DataShadow define
extern BYTE Port_2_Data_SHADE;
#define BL_DataShadow (*(unsigned char*)&Port_2_Data_SHADE)
//   BL_DriveMode_0Shadow define
extern BYTE Port_2_DriveMode_0_SHADE;
#define BL_DriveMode_0Shadow (*(unsigned char*)&Port_2_DriveMode_0_SHADE)
//   BL_DriveMode_1Shadow define
extern BYTE Port_2_DriveMode_1_SHADE;
#define BL_DriveMode_1Shadow (*(unsigned char*)&Port_2_DriveMode_1_SHADE)
