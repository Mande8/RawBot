...
;  Global Symbols
;-----------------------------------------------
export  Timer8Main_EnableInt
export _Timer8Main_EnableInt
export  Timer8Main_DisableInt
export _Timer8Main_DisableInt
export  Timer8Main_Start
export _Timer8Main_Start
export  Timer8Main_Stop
export _Timer8Main_Stop
export  Timer8Main_WritePeriod
export _Timer8Main_WritePeriod
export  Timer8Main_WriteCompareValue
export _Timer8Main_WriteCompareValue
export  Timer8Main_bReadCompareValue
export _Timer8Main_bReadCompareValue
export  Timer8Main_bReadTimer
export _Timer8Main_bReadTimer
export  Timer8Main_bReadTimerSaveCV
export _Timer8Main_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTimer8Main_ReadCompareValue  ; deprecated
export _bTimer8Main_ReadCompareValue  ; deprecated
export  bTimer8Main_ReadTimer         ; deprecated
export _bTimer8Main_ReadTimer         ; deprecated
export  bTimer8Main_ReadTimerSaveCV   ; deprecated
export _bTimer8Main_ReadTimerSaveCV   ; deprecated

export  bTimer8Main_ReadCounter       ; obsolete
export _bTimer8Main_ReadCounter       ; obsolete
export  bTimer8Main_CaptureCounter    ; obsolete
export _bTimer8Main_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_EnableInt
;
;  DESCRIPTION:
...
_Timer8Main_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8Main_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Main_DisableInt:
_Timer8Main_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8Main_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Main_WritePeriod:
_Timer8Main_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8Main_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer8Main_WriteCompareValue:
_Timer8Main_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8Main_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Main_bReadCompareValue:
_Timer8Main_bReadCompareValue:
 bTimer8Main_ReadCompareValue:                   ; this name deprecated
_bTimer8Main_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8Main_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer8Main_bReadTimerSaveCV:
_Timer8Main_bReadTimerSaveCV:
 bTimer8Main_ReadTimerSaveCV:                    ; this name deprecated
_bTimer8Main_ReadTimerSaveCV:                    ; this name deprecated
 bTimer8Main_ReadCounter:                        ; this name deprecated
_bTimer8Main_ReadCounter:                        ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[Timer8Main_CONTROL_REG]          ; save the Control register
   push  A
   mov   A, reg[Timer8Main_COMPARE_REG]          ; save the Compare register
   push  A
   mov   A, reg[Timer8Main_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8Main_COMPARE_REG]          ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Main_bReadTimer
;
;  DESCRIPTION:
...
;
 Timer8Main_bReadTimer:
_Timer8Main_bReadTimer:
 bTimer8Main_ReadTimer:                          ; this name deprecated
_bTimer8Main_ReadTimer:                          ; this name deprecated
 bTimer8Main_CaptureCounter:                     ; this name deprecated
_bTimer8Main_CaptureCounter:                     ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8Main_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8Main_COMPARE_REG]          ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File Timer8Main.asm
