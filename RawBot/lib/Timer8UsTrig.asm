...
include "m8c.inc"
include "memory.inc"
include "Timer8UsTrig.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Timer8UsTrig_EnableInt
export _Timer8UsTrig_EnableInt
export  Timer8UsTrig_DisableInt
export _Timer8UsTrig_DisableInt
export  Timer8UsTrig_Start
export _Timer8UsTrig_Start
export  Timer8UsTrig_Stop
export _Timer8UsTrig_Stop
export  Timer8UsTrig_WritePeriod
export _Timer8UsTrig_WritePeriod
export  Timer8UsTrig_WriteCompareValue
export _Timer8UsTrig_WriteCompareValue
export  Timer8UsTrig_bReadCompareValue
export _Timer8UsTrig_bReadCompareValue
export  Timer8UsTrig_bReadTimer
export _Timer8UsTrig_bReadTimer
export  Timer8UsTrig_bReadTimerSaveCV
export _Timer8UsTrig_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTimer8UsTrig_ReadCompareValue  ; deprecated
export _bTimer8UsTrig_ReadCompareValue  ; deprecated
export  bTimer8UsTrig_ReadTimer         ; deprecated
export _bTimer8UsTrig_ReadTimer         ; deprecated
export  bTimer8UsTrig_ReadTimerSaveCV   ; deprecated
export _bTimer8UsTrig_ReadTimerSaveCV   ; deprecated

export  bTimer8UsTrig_ReadCounter       ; obsolete
export _bTimer8UsTrig_ReadCounter       ; obsolete
export  bTimer8UsTrig_CaptureCounter    ; obsolete
export _bTimer8UsTrig_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_EnableInt
;
;  DESCRIPTION:
...
_Timer8UsTrig_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8UsTrig_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8UsTrig_DisableInt:
_Timer8UsTrig_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8UsTrig_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_Stop
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8UsTrig_WritePeriod:
_Timer8UsTrig_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8UsTrig_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer8UsTrig_WriteCompareValue:
_Timer8UsTrig_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8UsTrig_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8UsTrig_bReadCompareValue:
_Timer8UsTrig_bReadCompareValue:
 bTimer8UsTrig_ReadCompareValue:                 ; this name deprecated
_bTimer8UsTrig_ReadCompareValue:                 ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8UsTrig_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer8UsTrig_bReadTimerSaveCV:
_Timer8UsTrig_bReadTimerSaveCV:
 bTimer8UsTrig_ReadTimerSaveCV:                  ; this name deprecated
_bTimer8UsTrig_ReadTimerSaveCV:                  ; this name deprecated
 bTimer8UsTrig_ReadCounter:                      ; this name deprecated
_bTimer8UsTrig_ReadCounter:                      ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[Timer8UsTrig_CONTROL_REG]        ; save the Control register
   push  A
   mov   A, reg[Timer8UsTrig_COMPARE_REG]        ; save the Compare register
   push  A
   mov   A, reg[Timer8UsTrig_COUNTER_REG]        ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8UsTrig_COMPARE_REG]        ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8UsTrig_bReadTimer
;
;  DESCRIPTION:
...
;
 Timer8UsTrig_bReadTimer:
_Timer8UsTrig_bReadTimer:
 bTimer8UsTrig_ReadTimer:                        ; this name deprecated
_bTimer8UsTrig_ReadTimer:                        ; this name deprecated
 bTimer8UsTrig_CaptureCounter:                   ; this name deprecated
_bTimer8UsTrig_CaptureCounter:                   ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8UsTrig_COUNTER_REG]        ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8UsTrig_COMPARE_REG]        ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File Timer8UsTrig.asm
