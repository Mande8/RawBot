...
export LoadConfig_rawbot
export _LoadConfig_rawbot
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_rawbot
	lcall	LoadConfigTBL_rawbot_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration rawbot
;
;    Load configuration registers for rawbot.
...
_LoadConfig_rawbot:
 LoadConfig_rawbot:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_rawbot_Bank0
    mov     X, <LoadConfigTBL_rawbot_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_rawbot_Bank1
    mov     X, <LoadConfigTBL_rawbot_Bank1
