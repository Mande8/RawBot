...
include "m8c.inc"
include "memory.inc"
include "Timer8Trig.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  Timer8Trig_EnableInt
export _Timer8Trig_EnableInt
export  Timer8Trig_DisableInt
export _Timer8Trig_DisableInt
export  Timer8Trig_Start
export _Timer8Trig_Start
export  Timer8Trig_Stop
export _Timer8Trig_Stop
export  Timer8Trig_WritePeriod
export _Timer8Trig_WritePeriod
export  Timer8Trig_WriteCompareValue
export _Timer8Trig_WriteCompareValue
export  Timer8Trig_bReadCompareValue
export _Timer8Trig_bReadCompareValue
export  Timer8Trig_bReadTimer
export _Timer8Trig_bReadTimer
export  Timer8Trig_bReadTimerSaveCV
export _Timer8Trig_bReadTimerSaveCV

; The following functions are deprecated and subject to omission in future releases
;
export  bTimer8Trig_ReadCompareValue  ; deprecated
export _bTimer8Trig_ReadCompareValue  ; deprecated
export  bTimer8Trig_ReadTimer         ; deprecated
export _bTimer8Trig_ReadTimer         ; deprecated
export  bTimer8Trig_ReadTimerSaveCV   ; deprecated
export _bTimer8Trig_ReadTimerSaveCV   ; deprecated

export  bTimer8Trig_ReadCounter       ; obsolete
export _bTimer8Trig_ReadCounter       ; obsolete
export  bTimer8Trig_CaptureCounter    ; obsolete
export _bTimer8Trig_CaptureCounter    ; obsolete
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Trig_EnableInt:
_Timer8Trig_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8Trig_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Trig_DisableInt:
_Timer8Trig_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   Timer8Trig_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Trig_WritePeriod:
_Timer8Trig_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8Trig_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
;    functions.
;
 Timer8Trig_WriteCompareValue:
_Timer8Trig_WriteCompareValue:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[Timer8Trig_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_bReadCompareValue
;
;  DESCRIPTION:
...
;    functions.
;
 Timer8Trig_bReadCompareValue:
_Timer8Trig_bReadCompareValue:
 bTimer8Trig_ReadCompareValue:                   ; this name deprecated
_bTimer8Trig_ReadCompareValue:                   ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8Trig_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_bReadTimerSaveCV
;
;  DESCRIPTION:
...
;
 Timer8Trig_bReadTimerSaveCV:
_Timer8Trig_bReadTimerSaveCV:
 bTimer8Trig_ReadTimerSaveCV:                    ; this name deprecated
_bTimer8Trig_ReadTimerSaveCV:                    ; this name deprecated
 bTimer8Trig_ReadCounter:                        ; this name deprecated
_bTimer8Trig_ReadCounter:                        ; this name deprecated
...
bCount:        equ   1
   ...
   mov   A, reg[Timer8Trig_CONTROL_REG]          ; save the Control register
   push  A
   mov   A, reg[Timer8Trig_COMPARE_REG]          ; save the Compare register
   push  A
   mov   A, reg[Timer8Trig_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8Trig_COMPARE_REG]          ; Now grab DR2 (DR0) and save
   mov   [X+bCount], A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: Timer8Trig_bReadTimer
;
;  DESCRIPTION:
...
;
 Timer8Trig_bReadTimer:
_Timer8Trig_bReadTimer:
 bTimer8Trig_ReadTimer:                          ; this name deprecated
_bTimer8Trig_ReadTimer:                          ; this name deprecated
 bTimer8Trig_CaptureCounter:                     ; this name deprecated
_bTimer8Trig_CaptureCounter:                     ; this name deprecated

   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[Timer8Trig_COUNTER_REG]          ; synchronous copy DR2 <- DR0
                                                 ; This may cause an interrupt!
   mov   A, reg[Timer8Trig_COMPARE_REG]          ; Return DR2 (actually DR0)
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret

.ENDSECTION

; End of File Timer8Trig.asm
